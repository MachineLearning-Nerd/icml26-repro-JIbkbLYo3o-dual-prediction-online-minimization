...
![The exact caching combiner degrades linearly after one request replacement](images/c4-scaling.svg)
...
![Claim-level evidence status](images/claim-status.svg)
...
![The printed C6 construction and its corrected phase order](images/c6-proof-repair.svg)
...
![GHCN rain-threshold sensitivity](images/ghcn-sensitivity.svg)
